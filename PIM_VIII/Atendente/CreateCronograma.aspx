<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateCronograma.aspx.cs" Inherits="PIM_VIII.Atendente.CreateCronograma" %>
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                <br/>
                <asp:TextBox ID="txtDtInicio" runat="server" TextMode="Date"></asp:TextBox>
            </td>
            <td>
